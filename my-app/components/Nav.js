...
export default function Nav({show}) {
    ...
    return(
       <aside className={`${show ? 'left-0' : '-left-full'} top-0 text-gray-500 p-4 fixed w-full bg-bgGray h-full transition-all duration-300 z-50 md:static md:w-auto`}>
        ...
        <nav className="flex flex-col gap-2">
          ...
          <Link href={'/categories'} className={pathname.includes('/categories') ? activeLink : inactiveLink}>
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class={pathname.includes('/categories') ? activeIcon : inactiveIcon}>
